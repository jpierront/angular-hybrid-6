...
(function (global, factory) {
    ...
    var UIViewNgUpgrade = /** @class */ (function () {
        function UIViewNgUpgrade(ref, parent, registry // access the root state
            ...
            var ng1elem = angular.element(ref.nativeElement)
                .parent()
                .parent();
    ...
    var UIRouterUpgradeModule = /** @class */ (function () {
        ...
        UIRouterUpgradeModule.forRoot = function (module) {
            ...
            return {
                ...
                providers: angular$1.makeChildProviders(module),
            };
        };
        UIRouterUpgradeModule.forChild = function (module) {
            if (module === void 0) { module = {}; }
            return {
                ngModule: angular$1.UIRouterModule,
                providers: angular$1.makeChildProviders(module),
            };
        };
        UIRouterUpgradeModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        providers: [
                            ...
                            { provide: angular$1.UIROUTER_ROOT_MODULE, useValue: ɵ0, multi: true },
